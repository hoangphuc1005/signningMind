package com.MentalHealth.mental.base.customview;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorUnselectedBackgroundResId = R.drawable.gray_radius;
    private Animator mAnimatorOut;
    private Animator mAnimatorIn;
    private Animator mImmediateAnimatorOut;
    private Animator mImmediateAnimatorIn;
    private boolean mutliItemPerScreen;

    public boolean isMutliItemPerScreen() {
        return mutliItemPerScreen;
    }

    public void setMutliItemPerScreen(boolean mutliItemPerScreen) {
        this.mutliItemPerScreen = mutliItemPerScreen;
    }
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.red_radius, R.drawable.gray_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.red_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
                (mIndicatorUnselectedBackgroundResId == 0) ? R.drawable.gray_radius
                        : mIndicatorUnselectedBackgroundResId;
    }
    ...
    private void createIndicators() {
        removeAllViews();
        int count;
        if (isMutliItemPerScreen()) {
            count = mViewpager.getAdapter().getCount() - 1;
        } else {
